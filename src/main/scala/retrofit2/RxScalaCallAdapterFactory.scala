...
object RxScalaCallAdapterFactory extends CallAdapter.Factory {
  ...
  /**
   * This function is used to construct an observable. It executes the Call an notifies the subscriber
   * of the result.
   */
